...
// move to after tools (func-opts)
// or "forgetting the zero value"
...
// TODO: serialized types after maps as another example of leak
include::fix-serialized-types.adoc[]
include::fix-global.adoc[]

// Theme: the world outside your code is chaotic and out of your control.
// Restrict the chaos to the boundary of your packages,
// and control everything inside.
...
I outlined some patterns for code that *looks* like it leaks complexity.
However, there isn't really a hard list of rules we can build out of that.

Instead, I want to talk about an application holistically
which may help you find and hide complexity better.
--
