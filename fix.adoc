...
* I'll start by talking about some of the straightforward stuff;
  patterns you can use to help you towards future-proof code
* After that, I'll zoom out a little
  and talk about some of the higher level things you can do
  to avoid leaking complexity

As I get into this section,
please be aware that I'll be making some generalizations here.
I'm not saying "code that looks like this is leaky" but
"code that looks like this tends to leak."
...
// TODO: include::fix-initialize.adoc[]
include::fix-long-funcs.adoc[]
// TODO: many functions, adapt the long-funcs strategy
include::fix-primitives.adoc[]
// TODO: closures and objects
// TODO: callbacks and interfaces (even for functional options)
include::fix-return-iface.adoc[]
...
[.notes]
--
A lot of what I've talked so far has been fairly specific advice.
It's intended to help you recognize patterns indicative of complexity leaks
but it doesn't fix them. Not really.

Fixing it requires a more holistic view of the application.
--
...
--
Flow of information --
this is the path data takes through an application.
